...
int main()
{
	...
	cout << "Not correctly placed in the tree (0)\n" << test->is_word_in_tree("RYRYRY") << endl;
	cout << "This time the word should be correctly added(1)\n" << test->add_word_to_tree("RYRYRY") << endl;
	cout << "Checking if RYRYRY is in the tree" << test->is_word_in_tree("RYRYRY") << endl;
	cout << "Adding the same word to tree" << test->is_word_in_tree("RYRYRY") << endl;
